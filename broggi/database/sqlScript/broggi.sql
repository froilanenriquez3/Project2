...
CREATE TABLE IF NOT EXISTS `broggi`.`incidencies_has_recursos` (
  ...
  INDEX `fk_incidencies_has_recursos_afectats1_idx` (`afectat_id` ASC),
  ...
  CONSTRAINT `fk_incidencies_has_recursos_recursos1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
CONSTRAINT `fk_incidencies_has_recursos_afectat1`
...
-- -----------------------------------------------------
-- Table `broggi`.`Question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `broggi`.`Question` ;

CREATE TABLE IF NOT EXISTS `broggi`.`Question` (
  `id` INT NOT NULL auto_increment,
...
-- Table `broggi`.`Answer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `broggi`.`Answer` ;

CREATE TABLE IF NOT EXISTS `broggi`.`Answer` (
  `id` INT NOT NULL auto_increment,
