<template>
  <div class="container">
    ...
    <div id="incidenciesRecursosDiv" v-show="displayForm">
      <div
        class="d-flex d-flex justify-content-between align-items-center mb-5"
      >
        ...
        <div id="infoAfectat">
          ...
          <p v-show="afectat.edat != ''">
            <strong>Edat:</strong> {{ afectat.edat }}
          </p>
          <p v-show="afectat.edat == ''">
            <strong>Edat:</strong> No especificada
          </p>
          <p v-if="afectat.sexes_id == '1'"><strong>Sexe:</strong> Home</p>
          <p v-else><strong>Sexe:</strong> Dona</p>
        </div>
        <div class="d-flex align-items-center">
          <h5 id="incPrioritatDisp">Prioritat</h5>
          <p :class="infoRecursos.prioritat > 2 ? 'pink' : 'blue'">
            {{ infoRecursos.prioritat }}
          </p>
        </div>
      </div>
      ...
      <div class="container">
        <div class="form-group row mb-4">
          ...
          <input
            class="col-2 timeIn"
            type="time"
            v-model="infoRecursos.hora_activacio"
            id="activacio"
            name="activacio"
          ...
          <input
            class="col-2 timeIn"
            type="time"
            v-model="infoRecursos.hora_mobilitzacio"
            id="mobilitzacio"
            name="mobilitzacio"
            @change="validateInput('activacio', 'mobilitzacio')"
          />
        ...
        <div class="form-group row mb-4">
          ...
          <input
            class="col-2 timeIn"
            type="time"
            v-model="infoRecursos.hora_assistencia"
            id="assistencia"
            name="assistencia"
          ...
          <input
            class="col-2 timeIn"
            type="time"
            v-model="infoRecursos.hora_transport"
            id="transport"
            name="transport"
        ...
        <div class="form-group row mb-4">
          <label class="col-3" for="arribadaHospital"
            >5: Hora Arribada Hospital</label
          >
          <input
            class="col-2 timeIn"
            type="time"
            v-model="infoRecursos.hora_arribada_hospital"
            id="arribadaHospital"
            name="arribadaHospital"
            @change="validateInput('transport', 'arribadaHospital')"
          />
          <span class="col-1"></span>

          <label class="col-3" for="horaTransferencia"
            >6: Hora Transferencia</label
          >
          <input
            class="col-2 timeIn"
            type="time"
            v-model="infoRecursos.hora_transferencia"
        ...
        <div class="form-group row mb-4">
          ...
          <input
            class="col-2 timeIn"
            type="time"
            v-model="infoRecursos.hora_finalitzacio"
            id="finalitzacio"
            name="finalitzacio"
    ...
    findActiveIncidencia() {
      ...
      for (let i in me.incidenciesRecursos) {
        for (let j in me.incidenciesRecursos[i].incidencies_has_recursos) {
          ...
          if (
            me.incidenciesRecursos[i].incidencies_has_recursos[j].recursos_id ==
              me.userrecursoid &&
            me.incidenciesRecursos[i].incidencies_has_recursos[j]
              .hora_finalitzacio == null &&
            me.incidenciesRecursos[i].incidencies_has_recursos[j].prioritat >=
              me.highestPrioritat
          ) {
