    ...
    <div v-show="action == ''">
      ...
      <table v-else class="table">
        ...
        <tbody>
          <tr
            id="my-table"
            v-for="usuari in paginator(itemsToDisplay)"
            :key="usuari.id"
          >
      ...
      <div class="form-group row">
        ...
        >
          <option
            v-for="rol in rols"
            :key="rol.id"
            :selected="rol.id == usuari.rols_id"
            v-bind:value="rol.id"
          >
            {{ rol.nom }}
          </option>
      ...
      <div v-if="usuari.rols_id === 3" class="form-group row">
        ...
        >
          <option
            ...
            :key="recurs.id"
            :selected="recurs.id == usuari.recursos_id"
            v-bind:value="recurs.id"
          >
            {{ recurs.codi }} - {{ recurs.recurs.tipus }}
          </option>
        </select>
      </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div id="modalText" class="modal-body">
            Està segur d'esborrar l'usuari {{ usuari.nom }}
            {{ usuari.cognoms }} ?
          </div>
