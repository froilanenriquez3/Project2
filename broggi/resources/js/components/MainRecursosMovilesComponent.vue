<template>
  <div class="recursosMovilsContainer">
    ...
    <div v-show="action == ''">
      <!-- Filtro -->
      <filter-select
        :name="'Tipus de Recurs'"
        :listToFilter="recursos"
        :filterBy="tipus_recursos"
        :filterField="'tipus'"
        :relatedId="'tipus_recursos_id'"
    ...
    <div v-show="action == 'afegir' || action == 'editar'">
      ...
      <div class="form-group row">
        ...
        >
          <option
            v-for="recurso in tipus_recursos"
            :key="recurso.id"
      ...
      <button
        ...
        type="button"
        @click="editarRecurs()"
        class="btn btn_editar_recurs btn-warning"
        style="margin-top: 20"
      >
        Editar
      </button>
      ...
      <button
        type="button"
        @click="cerrarPagina()"
        class="btn btn_editar_recurs ml-3 border border-dark"
      >
        Enrere
      </button>
    </div>
