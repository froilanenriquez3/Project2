<template>
  <div
    class="nav-side my-5 pt-5 col-2 position-absolute fixed-top sticky-left align-items-center"
    style="top: 0"
  >
    <div id="logoSide" class="align-items-center col-2">
      <img
        src="/Project2/broggi/public/img/asideLogo.png"
    ...
    <div class="mt-5">
      ...
      >
        ...
        <ul id="side-menu nav-pills" class="nav flex-column">
          ...
          >
            <a
              v-bind:class="{ active: item == selectedSection }"
              class="nav-link"
              data-toggle="pill"
              href="#"
              role="tab"
